...
Current catalog: 16 core-tier packages, 6 plugin-tier extras, and 1 unscoped alias; all 23 publishable entries release in lockstep.
...
flowchart TB
  ...
  subgraph P_category_observability["observability"]
    ...
    P_mono_agent_observability_phoenix["@mono-agent/observability-phoenix\nplugin extra"]
  end
  ...
  P_mono_agent_observability_phoenix --> P_mono_agent_observability
  ...
  P_mono_agent_tui --> P_mono_agent_operator_adapter
...
| `@mono-agent/tui` | `@mono-agent/agent-contracts`, `@mono-agent/config`, `@mono-agent/observability`, `@mono-agent/operator-adapter` |
...
| `@mono-agent/observability-phoenix` | `@mono-agent/observability` |
...
| `@mono-agent/memory-supermemory` | `plugin` / `context` | Provides a MemoryStore over an external Supermemory instance (local OSS binary or hosted cloud) via its REST API: server-side extraction, hybrid recall, and awaited completed-turn admission. | [README for @mono-agent/memory-supermemory](./extras/memory-supermemory/README.md) · [npm for @mono-agent/memory-supermemory](https://www.npmjs.com/package/@mono-agent/memory-supermemory) |
...
| `@mono-agent/observability-phoenix` | `plugin` / `observability` | Exports recorded runs to Phoenix through bounded OTLP/HTTP protobuf requests when explicitly installed and configured. | [README for @mono-agent/observability-phoenix](./extras/observability-phoenix/README.md) · [npm for @mono-agent/observability-phoenix](https://www.npmjs.com/package/@mono-agent/observability-phoenix) |
