...
flowchart TB
  ...
  subgraph P_category_communication["communication"]
    ...
    P_mono_agent_messenger_adapter["@mono-agent/messenger-adapter\nplugin extra"]
  ...
  P_mono_agent_messenger_adapter --> P_mono_agent_agent_contracts
...
| --- | --- |
| `@mono-agent/agent-app` | `@mono-agent/agent-contracts`, `@mono-agent/agent-harness`, `@mono-agent/agent-runtime`, `@mono-agent/config`, `@mono-agent/cron-adapter`, `@mono-agent/memory`, `@mono-agent/observability`, `@mono-agent/openai-api-adapter`, `@mono-agent/operator-adapter`, `@mono-agent/runtime-adapter`, `@mono-agent/slack-adapter`, `@mono-agent/telegram-adapter`, `@mono-agent/web`, `@mono-agent/webhook-adapter` |
| `create-mono-agent` | `@mono-agent/agent-app` |
| `@mono-agent/web` | `@mono-agent/agent-contracts`, `@mono-agent/config`, `@mono-agent/observability`, `@mono-agent/operator-adapter` |
| `@mono-agent/a2a-adapter` | `@mono-agent/agent-contracts` |
| `@mono-agent/cron-adapter` | `@mono-agent/agent-contracts` |
| `@mono-agent/messenger-adapter` | `@mono-agent/agent-contracts` |
...
- The app pairs docs-mcp only as an explicitly installed authoring-harness companion; it is not injected into composed agents.
...
| `create-mono-agent` | `alias` / `app` | Unscoped npm-init installer (`npm create mono-agent`) shipping `create-mono-agent` and `mono-agent` bins that forward every command to @mono-agent/agent-app's CLI. | [README for create-mono-agent](./packages/create-mono-agent/README.md) · [npm for create-mono-agent](https://www.npmjs.com/package/create-mono-agent) |
...
| `@mono-agent/messenger-adapter` | `plugin` / `communication` | Adapts Facebook Messenger webhook events to structural agent requests and delivers final-only replies through the Send API. | [README for @mono-agent/messenger-adapter](./extras/messenger-adapter/README.md) · [npm for @mono-agent/messenger-adapter](https://www.npmjs.com/package/@mono-agent/messenger-adapter) |
...
| `@mono-agent/operator-adapter` | `core` / `communication` | Exposes the structured local operator NDJSON endpoint used by the browser console, ACP bridge, and jobs client. | [README for @mono-agent/operator-adapter](./packages/operator-adapter/README.md) · [npm for @mono-agent/operator-adapter](https://www.npmjs.com/package/@mono-agent/operator-adapter) |
...
| `@mono-agent/agent-runtime` | `core` / `runtime` | Provides the Pi SDK runtime bridge with native tools, MCP, sessions, compaction, and provider-catalog integration. | [README for @mono-agent/agent-runtime](./packages/agent-runtime/README.md) · [npm for @mono-agent/agent-runtime](https://www.npmjs.com/package/@mono-agent/agent-runtime) |
