...
**Lockstep set:** all **24 `publishable: true` packages** in
...
7 `tier: "plugin"` extras under `extras/*` (a2a-adapter, agent-orchestrator,
docs-mcp, memory-supermemory, messenger-adapter, observability-phoenix, and whatsapp-adapter). Plugin extras are version-bumped and
