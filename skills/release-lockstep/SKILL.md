...
**Lockstep set:** all **23 `publishable: true` packages** in
...
6 `tier: "plugin"` extras under `extras/*` (a2a-adapter, agent-orchestrator,
docs-mcp, memory-supermemory, messenger-adapter, and whatsapp-adapter). Plugin
extras are version-bumped and published alongside core.
