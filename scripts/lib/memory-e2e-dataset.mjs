...
export function makePlan({ corpus, sha256, split = "development", profile = null, codeRevision = null, limits = LIMITS[split], perCall = {} }) {
  ...
  const manifest = {
    ...
    perCall: { readerMaxTurns: 3, readerOutputTokens: 512, extractorOutputTokens: 2048, readerEstimatedInputTokens: 16384, extractorEstimatedInputTokens: 10240, readerHistoryHeadroomMessages: 8, framingAndToolAllowance: 4096, callTimeoutMs: 60000, embeddingTimeoutMs: DEFAULT_EMBEDDING_TIMEOUT_MS, readinessTimeoutMs: 120000, cleanupTimeoutMs: 10000, ...perCall },
