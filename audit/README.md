...
- [live-instances/](live-instances/) — personal-agent + ops-fleet deep evaluations *(the ops fleet
  was retired 2026-07-20 and replaced by the single-instance `~/agents/ops-assistant`; its audit is
