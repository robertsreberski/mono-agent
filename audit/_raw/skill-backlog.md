...
6. **Prove live-usage from manifests, read-only** *(B2-b)* — for
   ...
   ~/example-instance/.mono-agent/memory/.index/manifest.json
   ~/example-instance/.mono-agent/memory/.index/runtime.json
   ~/example-instance/.mono-agent/memory/.memory-forget-backup-*/manifest.json
   ```
