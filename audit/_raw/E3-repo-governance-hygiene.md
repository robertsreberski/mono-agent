...
- **Package deprecations via npm web UI** (`agents/release-engineer.md:56`, `skills/release-lockstep/SKILL.md:78`) — this is process guidance (the machine-level proxy-proxied CLI can't do it), not a deprecated code surface; both files agree with each other, no drift here.
