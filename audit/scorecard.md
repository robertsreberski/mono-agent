...
| [ops-fleet](live-instances/ops-fleet.md) | **B+** | **C+** | Meticulously engineered fleet that proves the primitives — but had to hand-build multi-agent delivery reliability, crash-loop protection, and shared knowledge, mapping the framework's post-v1 gaps. |
