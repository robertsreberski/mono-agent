...
|---|---|---|
| 0 · Inventory | Authoritative manifests: 1,106 tracked repo files + depth-2 territory maps of `~/example-instance` (7,300 files) and `~/ops-agents` (275) — `_raw/manifest-*.txt` | main loop |
...
| live: ~/example-instance | live-instances/personal-agent.md | PASS |
| live: ~/ops-agents | live-instances/ops-fleet.md | PASS |
