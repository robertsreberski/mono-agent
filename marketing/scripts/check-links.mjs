// Post-build: validate every internal link in the generated dist/ resolves to
// a real file. Shared shape with website/scripts/check-links.mjs — runs after
// `astro build` and exits non-zero on any broken link.
...
// Map an internal href/src to the dist file it should resolve to.
