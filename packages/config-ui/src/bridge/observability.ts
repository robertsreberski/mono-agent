...
import type { ConfigUiObservabilityOptions } from "./types.js";
...
export async function observabilityRunsResponse(
  options: ConfigUiObservabilityOptions | undefined,
...
async function resolveObservability(options: ConfigUiObservabilityOptions | undefined): Promise<ResolvedObservability> {
  if (options === undefined) {
    return { enabled: false, warnings: ["Observability is not configured for this bridge."] };
  }
