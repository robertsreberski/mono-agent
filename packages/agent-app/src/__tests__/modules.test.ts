...
describe("known-tools", () => {
  ...
  it("recognizes exact built-in and adapter-send tool names, case-sensitively", () => {
    ...
    expect(APP_TOOL_NAMES).toEqual(["RunHistory", "SessionHistory", "SetConversationTitle", "ListProjects", "GetProject", "CreateProject", "UpdateProject", "DeleteProject", "ListConversations", "CreateConversation", "SetConversationProject", "MemoryJournal", "Remember"]);
