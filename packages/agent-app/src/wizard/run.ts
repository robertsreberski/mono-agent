...
function toolSituationFraming(draft: DraftAnswers, alwaysOn: readonly string[]): string {
  ...
  return [
    ...
    "App tools: RunHistory (settled-run recovery evidence, including cancelled/interrupted work) and SessionHistory (bounded retained tool calls/results in this session).",
    channelLine,
