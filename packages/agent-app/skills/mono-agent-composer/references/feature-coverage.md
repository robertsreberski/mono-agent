...
| Guarded self-authoring of local skills and cron jobs | config | `selfCapabilities.{enabled,mode,skillsRoot,cronDir,auditDir}`; default off, `mode: "propose"`; create tools require `MONO_AGENT_SELF_CAPABILITIES_CONFIRMATION_TOKEN` |
