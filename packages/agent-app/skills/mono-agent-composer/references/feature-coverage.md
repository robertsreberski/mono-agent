...
| Memory out-of-band maintenance CLI (rebuild/recall/index/reflect/migrate) | cli | `memory-bujo <subcommand> <root>`; `MONO_AGENT_EMBED_MODEL`, `MONO_AGENT_EMBED_DIM`; `MONO_AGENT_LLM_MODEL`, `MONO_AGENT_LLM_ENDPOINT` required for reflect/migrate |
