...
describe("createStreamSubscriber — tool lifecycle + timing", () => {
  ...
  it("copies only bounded non-sensitive outcome fields onto tool timing", () => {
      ...
      result: {
        ...
        details: {
          outcome: {
            ...
            retryAt: "2026-09-06T12:00:00.000Z",
            nextAction: "fetch_existing_sources",
            retryInRun: false,
            fallbackUsed: true,
            hadDecodingReplacement: false,
    ...
    expect(timing).toMatchObject({
      ...
      extraction_stage: "readability",
      render_reason: "sparse_html",
      redirect_count: 2,
      ...
      rendered: false,
      render_failed: true,
      browser_recommended: true,
      retry_at: "2026-09-06T12:00:00.000Z",
      next_action: "fetch_existing_sources",
      retry_in_run: false,
      fallback_used: true,
