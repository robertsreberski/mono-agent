...
describe("parseBullet/serializeBullet", () => {
  ...
  it("round-trips byte-for-byte for task/event/note across statuses", () => {
    const samples = [
      ...
      '- – Example Operator prefers opt-in, never silent fallback.  <!--mem id=01E type=note status=open salience=0.9 isInsight=1 created=2026-06-15T12:00:00.000Z refs=01C-->',
    ];
