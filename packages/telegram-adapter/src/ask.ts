/**
 * Shared convention for the `TelegramAskButtons` inline-keyboard round-trip.
 *
 * The agent-app `TelegramAskButtons` tool builds an inline keyboard whose buttons carry
...
/** Maximum number of options a single `TelegramAskButtons` keyboard may carry. */
...
/** True when `data` is a `TelegramAskButtons` callback payload. */
