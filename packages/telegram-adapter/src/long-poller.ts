...
import type { TelegramUpdateHandlingResult } from "./adapter.js";
...
export class TelegramLongPoller {
  ...
  private readonly adapter: TelegramUpdateHandler;
  ...
  constructor(options: TelegramLongPollerOptions) {
    ...
    if (typeof options.adapter?.handleUpdate !== "function") {
      throw new TypeError("TelegramLongPoller requires an adapter with handleUpdate().");
    }
