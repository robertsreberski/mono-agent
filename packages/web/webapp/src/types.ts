...
export type RestartOperation = Wire.WebAgentRestartOperation;
export type RestartProposalPart = Extract<Wire.WebMessagePart, { readonly type: "restart_proposal" }>;
export type RestartProposalAvailability = Wire.WebRestartProposalAvailability;
