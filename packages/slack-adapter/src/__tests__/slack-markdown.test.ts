...
describe("normalizeSlackMarkdownToMarkdown", () => {
  it("normalizes Slack standup-style bullets, links, nbsp indentation, and emphasis", () => {
    const slack = [
      ...
      "\u00a0\u00a0\u25e6 Cut and coordinated <https://github.com/example-org/example-repo/releases/tag/2.0-beta|Example 2.0-beta>, including <https://tracker.example.com/issue/EX-1081/example-20-beta|EX-1081>.",
      "",
      "\u2022 _Example.com / Example 2026 launch work_",
      "\u00a0\u00a0\u25e6 Landed <https://git.example.com/example-org/example-themes/pull/157805|theme update>.",
    ].join("\n");

    expect(normalizeSlackMarkdownToMarkdown(slack)).toBe(
      [
        "- Example 2.0 release lead / release wrangling",
        "  - Cut and coordinated [Example 2.0-beta](https://github.com/example-org/example-repo/releases/tag/2.0-beta), including [EX-1081](https://tracker.example.com/issue/EX-1081/example-20-beta).",
        "",
        "- *Example.com / Example 2026 launch work*",
        "  - Landed [theme update](https://git.example.com/example-org/example-themes/pull/157805).",
      ].join("\n"),
    );
  });
