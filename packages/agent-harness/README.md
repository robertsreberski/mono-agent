...
Capture-mode admission includes bounded, host-owned outer-user evidence and a
category-only digest of observed tool outcomes when a failure occurred. Tool
