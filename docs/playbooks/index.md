...
| [Cron Digest with Proactive Slack Notify](/playbooks/cron-digest-proactive-notify/) | Data analyst wanting a scheduled briefing pushed to the team | Timezone-aware cron job that builds a daily digest with shared history and proactively posts it to Slack via the send tool. |
