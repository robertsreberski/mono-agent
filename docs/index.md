...
- **Batteries included** — common Read/Write/Edit/Glob/Grep/Bash/WebFetch/WebSearch tools, Pi's run-scoped NodeRepl, a tool policy, MCP servers, a native sandbox, tiered memory, and observability.
