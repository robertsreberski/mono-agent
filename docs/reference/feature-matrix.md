...
| `runtime.providers` | config | `providers.entries[]`, `providers.local[]`, `providers.piAuthPath`, `providers.piNative.*` | `MONO_AGENT_PROVIDERS_JSON`, `MONO_AGENT_PI_AUTH_PATH`, `MONO_AGENT_PI_*` | [Providers](/runtime/providers/) | — |
