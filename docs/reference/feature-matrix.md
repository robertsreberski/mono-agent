...
| `runtime.web-research` | config + auto | `tools.web.search.*`, `tools.web.fetch.*` | `MONO_AGENT_WEB_SEARCH_BACKEND`, `MONO_AGENT_WEB_SEARCH_ENDPOINT`, `MONO_AGENT_WEB_SEARCH_CODEX_MODEL`, `MONO_AGENT_WEB_FETCH_RENDER`, `MONO_AGENT_WEB_BROWSER_COMMAND` | [Local-first web research](/tools/web-research/) | [Local-first web research agent](/playbooks/local-web-research/) |
