...
| `acp.worklab-bridge` | cli + code | `mono-agent bridge acp --discover`; `mono-agent bridge acp --source-id <id>`; `discoverAcpBridgeAgents()` | — | [Worklab ACP bridge](/programmatic/acp-bridge/) | — |
