...
`code` — coverage type. See `runtime.approval-gates` in [feature-registry.md](/reference/feature-registry/).
...
`code` — coverage type. See `runtime.structured-output` in [feature-registry.md](/reference/feature-registry/).
...
`code` — coverage type. See `runtime.live-input` in [feature-registry.md](/reference/feature-registry/).
