...
| `tools.web.search.backend` | `string` | `MONO_AGENT_WEB_SEARCH_BACKEND` | auto | `auto` | WebSearch backend: auto tries a configured local SearXNG endpoint then keyless fallbacks; searxng is strict; keyless skips SearXNG. |
