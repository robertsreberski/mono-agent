...
| `runtime.compaction.triggerRatio` | `number` | `MONO_AGENT_COMPACTION_TRIGGER_RATIO` | 0.7 | `0.7` | Fraction of the effective model context window used for the proactive trigger, additionally capped by adaptive safety headroom (10% of the window, 16,000-48,000 tokens). |
