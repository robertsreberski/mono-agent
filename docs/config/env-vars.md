...
| `MONO_AGENT_COMPACTION_TRIGGER_RATIO` | `runtime.compaction.triggerRatio` | Proactive window ratio, `0.2`-`0.95`; default `0.70`, additionally capped by adaptive safety headroom (`10%` of the window, `16,000`-`48,000` tokens). |
