...
| `.mono-agent/history/` | Bounded active conversation history for cold/non-resumable replay. The default keeps 64 messages per exact conversation id and survives ordinary restarts. | automatic; stored beside `artifacts.dir` |
