...
bar also carries an on-track cap at the elapsed share of the window — a small
rounded marker in the meter's accent family, lightened where the fill has
already passed it — and a
